...
#pragma mark CDVUIInAppGloginBrowser

@interface CDVUIInAppGloginBrowser () {
    NSInteger _previousStatusBarStyle;
}
@end

@implementation CDVUIInAppGloginBrowser

static CDVUIInAppGloginBrowser* instance = nil;
...
- (void)openInInAppBrowser:(NSURL*)url withOptions:(NSString*)options
{
    ...
    // if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[CDVUIInAppBrowserGloginViewController alloc] initWithUserAgent:userAgent prevUserAgent:userAgent browserOptions: browserOptions];
...
#pragma mark CDVUIInAppBrowserGloginViewController

@implementation CDVUIInAppBrowserGloginViewController
