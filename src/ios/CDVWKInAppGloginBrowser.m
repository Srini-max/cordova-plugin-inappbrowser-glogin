...
#pragma mark CDVWKInAppGloginBrowser

@interface CDVWKInAppGloginBrowser () {
    NSInteger _previousStatusBarStyle;
}
@end

@implementation CDVWKInAppGloginBrowser

static CDVWKInAppGloginBrowser* instance = nil;
...
- (void)openInInAppBrowser:(NSURL*)url withOptions:(NSString*)options
{
   ...
   // if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[CDVWKInAppBrowserGloginViewController alloc] initWithUserAgent:userAgent prevUserAgent:userAgent browserOptions: browserOptions];
...
- (void)show:(CDVInvokedUrlCommand*)command withNoAnimate:(BOOL)noAnimate
{
    ...
    __block CDVInAppBrowserGloginNavigationController* nav = [[CDVInAppBrowserGloginNavigationController alloc]
...
#pragma mark CDVWKInAppBrowserGloginViewController

@implementation CDVWKInAppBrowserGloginViewController
...
- (id)initWithUserAgent:(NSString*)userAgent prevUserAgent:(NSString*)prevUserAgent browserOptions: (CDVInAppBrowserGloginOptions*) browserOptions
{
    self = [super init];
    if (self != nil) {
        ...
        self.webViewUIDelegate = [[CDVWKInAppGloginBrowserUIDelegate alloc] initWithTitle:[[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleDisplayName"]];
...
- (void)navigateTo:(NSURL*)url
{
    ...
    if (_userAgentLockToken != 0) {
        ...
        __weak CDVWKInAppBrowserGloginViewController* weakSelf = self;
